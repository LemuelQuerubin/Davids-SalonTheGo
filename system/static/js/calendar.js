        ...
        try {
            ...
            for(let i=0; i<5; i++){ //loop thru 35 boxes on the calendar month
                ...
                <ol class="days list-unstyled" week="${d.week()}">
                    <li class="${d.add(1,'d'),this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?' outside':'inside'}${isSameDate(d,now)?' today':''}"><button name="date" value="${d.year() + "-" + (parseInt(d.month())+1) + "-" + d.format('D')}" ${this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?'disabled':''} month="${d.month()}" year="${d.year()}" class="date">${d.format('D')}</button><div class="events"></div></li>
                    <li class="${d.add(1,'d'),this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?' outside':'inside'}${isSameDate(d,now)?' today':''}"><button name="date" value="${d.year() + "-" + (parseInt(d.month())+1) + "-" + d.format('D')}" ${this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?'disabled':''} month="${d.month()}" year="${d.year()}" class="date">${d.format('D')}</button><div class="events"></div></li>
                    <li class="${d.add(1,'d'),this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?' outside':'inside'}${isSameDate(d,now)?' today':''}"><button name="date" value="${d.year() + "-" + (parseInt(d.month())+1) + "-" + d.format('D')}" ${this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?'disabled':''} month="${d.month()}" year="${d.year()}" class="date">${d.format('D')}</button><div class="events"></div></li>
                    <li class="${d.add(1,'d'),this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?' outside':'inside'}${isSameDate(d,now)?' today':''}"><button name="date" value="${d.year() + "-" + (parseInt(d.month())+1) + "-" + d.format('D')}" ${this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?'disabled':''} month="${d.month()}" year="${d.year()}" class="date">${d.format('D')}</button><div class="events"></div></li>
                    <li class="${d.add(1,'d'),this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?' outside':'inside'}${isSameDate(d,now)?' today':''}"><button name="date" value="${d.year() + "-" + (parseInt(d.month())+1) + "-" + d.format('D')}" ${this.m != d.month() || this.m < a || (this.m > a && d.format('D') > b) || this.m > a+1 || (this.m == a && d.format('D') < b) || d.year() > c?'disabled':''} month="${d.month()}" year="${d.year()}" class="date">${d.format('D')}</button><div class="events"></div></li>
